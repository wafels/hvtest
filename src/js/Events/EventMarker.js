...
var EventMarker = Class.extend(
    ...
    createMarker: function (zIndex) {
        ...
        markerURL = settingsJSON['static_asset_url']+'resources/images/eventMarkers/'+this.event_type.toUpperCase()+'@2x'+'.png';
    ...
    createRegion: function (zIndex) {
        if ( this.hpc_boundcc != '' ) {
            ...
            this.eventRegionDomNode.css({
                          ...
                          'z-index' :  zIndex,
                 'background-image' : "url('" + settingsJSON['static_asset_url'] + this.hv_poly_url + "')",
